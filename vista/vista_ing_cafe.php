...
<html>
    <head>
        ...
        <script>
            function cancelar(){
                //location.href="../controlador/controlador_cafe.php?opcion=1";
                window.close();
            }
            function init(){
    ...
    <body >
        <div class="container" style="margin-bottom:30px">
            <img src="../images/banner-cafes.jpeg" class="img-responsive" style="width: 100%;height: 290px">
            <h3 style="text-align: center;margin-top: 30px;margin-bottom: 20px;color: #5F4C0B" >REGISTRO DE CAFES </h3>           
                       
        <form id="frmReg" name="frmReg" action="../controlador/controlador_cafe.php?opcion=2" method="POST" enctype="multipart/form-data" >
