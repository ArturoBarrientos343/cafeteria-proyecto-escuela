...
<html lang="es">
  ...
  <body>
    <div class="container">
        ...
        <h3 style="text-align: center;margin-top: 30px;margin-bottom: 30px;color: #5F4C0B" >RECOJOS DE CAFES EN TIENDA </h3>
        <div class="row">
            <div class="col-6">
