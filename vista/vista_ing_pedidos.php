...
<title>Pedido de compra | Cafetería</title>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#div-btn1').click(function(e) {                
            e.preventDefault();                                        
            var xidcafe = document.getElementById('idpane').value;
            ...
            $.ajax({
                ...
                cache:false,
                url: "../controlador/controlador_detalle.php",                
                data:{opcion:2,idcafe:xidcafe,txtCan:xcan,txtDescto:xdescto},                
        ...
        $('#idpane').on('click', function() {     
            ...
            $.ajax({
                ...
                cache:false,
                url: "../controlador/controlador_cliente.php",                
                data:{opcion:10,idcli:xidcli, idcafe:xidpane},
                success: function(a) {
                    $('#descuento').html(a);                    
...
<div class="container">
        ...
        <h3 style="text-align: center;margin-top: 30px;margin-bottom: 30px; color: #5F4C0B"" >PEDIDO DE CAFES </h3>        
</div>
<div class="container">
        ...
        <div class="row" id="forma" style="margin-top:10px">
            <div class="col-4">
                <select name ="idpane" id="idpane" class="form-control" >
                    <?php
                        include_once '../controlador/controlador_cafe.php';                    
                        combo_cafes();
                    ?>
                </select>
            </div>
